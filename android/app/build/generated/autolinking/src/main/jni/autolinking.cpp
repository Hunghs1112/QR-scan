...
auto module_LibCameraImageCodeBankSpec = LibCameraImageCodeBankSpec_ModuleProvider(moduleName, params);
if (module_LibCameraImageCodeBankSpec != nullptr) {
return module_LibCameraImageCodeBankSpec;
}
auto module_LibScanImageCodeBankSpec = LibScanImageCodeBankSpec_ModuleProvider(moduleName, params);
if (module_LibScanImageCodeBankSpec != nullptr) {
return module_LibScanImageCodeBankSpec;
}
