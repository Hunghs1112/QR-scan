...
// import { BankKey } from './BankKey';

// export enum VietQRStatus {
//     NOT_SUPPORTED = -1,       // Không hỗ trợ VietQR
//     RECEIVE_ONLY = 0,         // Chỉ nhận tiền qua VietQR
//     TRANSFER_SUPPORTED = 1,   // Hỗ trợ chuyển tiền qua VietQR
// }
...
//     deprecated?: boolean;
// }
// export const BanksObject: Record<BankKey, BankInfo> = {
//     [BankKey.ABBANK]: {
//         key: BankKey.ABBANK,
...
// }
// };
// export const Banks: BankInfo[] = Object.values(BanksObject);
